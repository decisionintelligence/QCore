...
class Flipping(torch.nn.Module):
    def __init__(self,output_size=9,length=10):
        super(Flipping, self).__init__()
        self.layer1 = nn.Conv1d(in_channels=128, out_channels=32, kernel_size=5)
        self.layer2 = nn.Linear(length-4,output_size)
...
class Conv1dFlip(nn.Module):
    ...
    def __init__(self, mode=None, wbit=None, abit=None, args=None):
        ...
        self.model_1 = quantize_model(model_1)
